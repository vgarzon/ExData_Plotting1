...
# - - - - - - - - - - - - - Upper Left - - - - - - - - - - - - - - - - 
# Plot time series
plot(Global_active_power ~ DateTime, hpc, type = 'l', xlab = "",
...
# - - - - - - - - - - - - - Upper Right - - - - - - - - - - - - - - - - 
plot(Voltage ~ DateTime, hpc, type = 'l', xlab = "datetime")

# - - - - - - - - - - - - - Lower Right - - - - - - - - - - - - - - - - 
plot(Global_reactive_power ~ DateTime, hpc, type = 'l', xlab = "datetime")
